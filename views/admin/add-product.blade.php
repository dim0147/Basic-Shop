...
<div class="form">
    <form method="POST">
        ...
        <div>title: <input name="title" value="4"  /></div>
        <div>description: <input name="description" value="4"  /></div>
        <div>price: <input name="price" value="4"  /></div>
        <div>status: <input name="status" value="4"  /></div>
        <div>rate: <input name="rate" value="4"  /></div>
